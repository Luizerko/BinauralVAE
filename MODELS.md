...
<p align="center">
    <br>
  <img src="assets/mel_vae.png" alt="mel vae" width="398" />
  <br>
</p>

*Figure 1: Architecture overview of the Mel Spectrogram VAE, taking binaural Mel Spectrograms as input.*

*Figure 2 + Audio 1: Comparison of the original Mel spectrogram example (left) versus the reconstructed output (right). Listen to what they sound via Griffin-Lim reconstruction of each version below the images.*

*Audio 2: A binaural audio dream generated by the Mel Spectrogram VAE.*
...
*Figure 3: Architecture overview of the STFT 4-Channel Stacked VAE, taking binaural STFT Magnitude + Phase as input.*

*Figure 4 + Audio 3: Comparison of the original magnitude and phase example (left) versus the reconstructed output (right). Listen to the direct inverse STFT playback of each version below the images.*

*Audio 4: A binaural audio dream generated by the STFT 4-Channel Stacked VAE.*
...
*Figure 5: Architecture overview of the CVAE network, taking binaural complex STFT as input.*

*Figure 6 + Audio 5: Comparison of the original magnitude and phase example (left) versus the reconstructed output (right). Listen to the direct inverse STFT playback of each version below the images.*

*Audio 6: A binaural audio dream generated by the CVAE.*